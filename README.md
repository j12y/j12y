...
<td width="25%" valign="top" style="padding-top: 20px; padding-bottom: 20px; padding-left: 30px; padding-right: 30px;">
  ...
  <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--MuoC_hrx--/c_imagga_scale,f_auto,fl_progressive,h_500,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/whl9h3tbajzh268t5noq.png"/>
  <p><b><a href="https://dev.to/j12y/customer-zero-testing-5gii">How-to Run a Customer Zero Testing Program</a></b></p>
  <p>Some teams have a perverse pride that comes from "we test in production" but that can be a path to a......</p>
</td>
<td width="25%" valign="top" style="padding-top: 20px; padding-bottom: 20px; padding-left: 30px; padding-right: 30px;">
